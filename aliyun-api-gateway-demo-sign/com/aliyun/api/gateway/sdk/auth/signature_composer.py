...
def build_sign_str(uri=None, method=None, headers=None, body=None, sign_with_body=True):
    lf = '\n'
    string_to_sign = []
    ...
    string_to_sign.append(_build_resource(uri=uri, body=body, sign_with_body=sign_with_body))
